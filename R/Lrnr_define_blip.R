...
#' Function factory for blip regression
#' @param counterfactual_0 A \code{Counterfactual} object defining one possible intervention
#' @param counterfactual_1 A \code{Counterfactual} object defining a second possible intervention
