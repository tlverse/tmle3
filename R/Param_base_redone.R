...
Param_base2 <- R6Class(
  ...
  public = list(
    ...
    eic_components = function(tmle_task = NULL, fold_number = "full") {
      # Returns list containing EIC components for each node to be targetted
      # Needed for one dimensionalsubmodel
      # colMeans should be ED
      # colVars should be var(EIC)
      #Should not be in long format
      stop("Param_base is a base class")
    },
