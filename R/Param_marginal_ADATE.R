...
#'
#' Parameter definition for Marginal Average Treatment Effect under Adaptive Design (Marginal ADATE): $P_{0,W}[E(Y|A=1,W)-E(Y|A=0,W)]$. Currently supports adaptive design for BINARY intervention nodes.
...
#' }
#' @export
Param_marginal_ADATE <- R6Class(
  classname = "Param_marginal_ADATE",
  portable = TRUE,
  class = TRUE,
  inherit = Param_base,
  public = list(
