#' @section Constructor:
#'   \code{make_tmle3_task(data, tmle_nodes, ...)}
#'                      
#'   \describe{
#'     \item{\code{data}}{A \code{data.frame} or \code{data.table} containing the underlying data
#'     }
#'     \item{\code{tmle_nodes}}{A list of \code{\link{tmle3_Node}} objects, where each is created using \code{\link{define_node}}. These specify the NPSEM. See examples.
#'     }
...
#'     \item{\code{new_data}: A \code{data.frame} or \code{data.table} with the counterfactual values. Column names must refer to node names in the \code{tmle_nodes} for this task.
#'     }
#'   }
#'   }
#'}
...
#' @section Fields:
#' \describe{
#'   \item{\code{tmle_nodes}}{The list of \code{\link{tmle3_Node}} objects specifying the NPSEM}
#' }
