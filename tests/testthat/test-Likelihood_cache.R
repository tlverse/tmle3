...
print(head(likelihood_values))
A_values <- likelihood$cache$get_values(A_factor, tmle_task, "full") #[, "A", with = F][[1]]
Y_values <- likelihood$cache$get_values(Y_factor, tmle_task, "full") #[, "Y", with = F][[1]]
