...
task <- tmle3_Task$new(long_data, npsem, time = "t", id = "id", long_format = T)
...
print(head(task$get_regression_task("L1", is_time_variant = T)$data))
print(head(task$get_regression_task(c("L1", "L2"), is_time_variant = T)$data))
