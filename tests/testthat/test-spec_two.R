...
tmle_task <- tmle_spec$make_tmle_task(data, node_list)
# construct likelihood, don't fit it
# initial_likelihood <- tmle_spec$make_initial_likelihood(tmle_task, learner_list)
initial_likelihood <- tmle_spec$make_initial_likelihood(learner_list)
# now tmle fitter fits likelihood

# define updater
updater <- tmle_spec$make_updater()

# now tmlefitter constructs targeted likelihood
targeted_likelihood <- tmle_spec$make_targeted_likelihood(initial_likelihood, updater)

tmle_params <- tmle_spec$make_params(tmle_task, initial_likelihood)


# pass everything to fit
