...
results <- na.omit(simn2000)
#results <- na.omit(sim500)
#results <- na.omit(sim)
sqrt(n) *mean(results$ICtilde)
sqrt(n) *mean(results$Pnlast)


results <- results[, c(4,5,6)]
results$X1 <- NULL
hists <- apply(results,2, hist)
