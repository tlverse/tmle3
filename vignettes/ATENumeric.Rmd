...
```{r}
tlik <- Targeted_Likelihood$new(likelihood,submodel_type_by_node = "EIC" , updater = list(convergence_type = "sample_size", constrain_step = T))
...
as.data.table(tlik$get_likelihood(task, "Y"))
mean(param$estimates(task)$IC)
```
