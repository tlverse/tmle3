...
```{r}
param = Param_CR$new(likelihood, list("A" = LF_static$new("A", value = 1)), competing_risk_nodes = c("processN2"), target_risk_node = "processN1", marginalized = T)
param$name
...
sum(long_data$Delta==1)
sum(long_data$Delta==2)
