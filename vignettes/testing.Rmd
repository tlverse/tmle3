...
data$Ttilde <- data_surv$Ttilde
 ...
 data <-  data[, -grep("[d][N].+", colnames(data))]
  ...
  tmle_spec_np <- tmle3_Spec_coxph$new(formula = ~1,  delta_epsilon = 0.1, verbose = T, treatment_level = 1, control_level = 0)
  learner_list <- list(A = Lrnr_gam$new() , N = Lrnr_hal9001$new(smoothness_orders = 0, num_knots = 20, max_degree = 1), A_c = Lrnr_hal9001$new(smoothness_orders = 0, num_knots = 20, max_degree = 1) )
