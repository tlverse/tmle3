...
```{r}
tlik <- Targeted_Likelihood$new(lik_trained, updater = list(one_dimensional=T, maxit = 50, convergence_type = "sample_size"))
...
print(data.table(observed_dN_wide))
