...
#ctask$get_tmle_node("processN", compute_risk_set = T, expand = T)
...
cf_task$force_at_risk
cf_task$get_tmle_node("processN", compute_risk_set = T, expand = T)
cf_task$get_data()
cf_task$get_regression_task("processN")$get_data()
lik_trained$get_likelihood(cf_task, "processN",  to_wide = T)

```

```{r}
lik_trained$get_likelihood(task, "processN", drop_time = F, drop_id = F, to_wide = TF
```
